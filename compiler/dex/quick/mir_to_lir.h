...
class Mir2Lir {
  public:
    ...
    #ifdef MTK_ART_COMMON
    virtual bool MTKUseGCMapWithouRegisterPromotion() { return false; }
    #endif
    ...
    #ifdef MTK_ART_COMMON
    virtual RegStorage AllocPreservedSingle(int s_reg ATTRIBUTE_UNUSED, int reg ATTRIBUTE_UNUSED) { UNREACHABLE(); }
    virtual RegStorage AllocPreservedDouble(int s_reg ATTRIBUTE_UNUSED, int reg ATTRIBUTE_UNUSED) { UNREACHABLE(); }
    virtual RegStorage AllocPreservedCoreReg(int s_reg ATTRIBUTE_UNUSED, int reg ATTRIBUTE_UNUSED) { UNREACHABLE(); }
    virtual RegStorage AllocPreservedFpReg(int s_reg ATTRIBUTE_UNUSED, int reg ATTRIBUTE_UNUSED) { UNREACHABLE(); }
    #endif
    ...
    #ifdef MTK_ART_COMMON
    virtual LIR* MTKGenNullCheck(RegStorage reg, int opt_flags);
    virtual void MTKMarkPossibleNullPointerException(int opt_flags);
    virtual void MTKForceImplicitNullCheck(RegStorage reg, int opt_flags);
    void SetTargetInfo(TargetInfo* target_info) { target_info_ = target_info; }
    const TargetInfo* GetTargetInfo() { return target_info_; }
    #endif
    ...
    virtual bool IsHoistableLIR(LIR* lir ATTRIBUTE_UNUSED) { return false; }
    virtual void ApplyGlobalOptimizations() {}
    virtual bool MtkHandleExtendedMethodMIR(BasicBlock* bb ATTRIBUTE_UNUSED,
                                            MIR* mir ATTRIBUTE_UNUSED) { return false; }
