...
class Arm64Mir2Lir FINAL : public Mir2Lir {
 ...
 public:
  ...
  protected:
    virtual int MTKGenArrayGet1(int data_offset, int scale ATTRIBUTE_UNUSED,
                                bool wide ATTRIBUTE_UNUSED) { return data_offset; }
    virtual void MTKGenArrayGet2(bool needs_range_check ATTRIBUTE_UNUSED,
                                 int data_offset ATTRIBUTE_UNUSED,
                                 RegStorage reg_ptr ATTRIBUTE_UNUSED) {}
#else
