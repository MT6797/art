...
enum LIRPseudoOpcode {
  kPseudoLoopPreHeader = -24,  // MTK OPT Extension
  kPseudoLoopPreBody = -23,    // MTK OPT Extension
  kPseudoLoopStart = -22,      // MTK OPT Extension
  kPseudoLoopBodyEnd = -21,    // MTK OPT Extension
  kPseudoLoopHeader = -20,     // MTK OPT Extension
  kPseudoLoopEnd = -19,        // MTK OPT Extension
