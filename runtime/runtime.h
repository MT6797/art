...
class MTKRuntime;
void MTK_CreateJit(jit::Jit* jit);
MTKRuntime* GenMTKRuntime();
bool MTK_NeedsInterpreter(ArtMethod* method) SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
void MTK_registerAppInfo(const char* profiling_filename, jit::Jit* jit);
#endif
