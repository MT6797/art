...
bool Runtime::Start() {
  ...
  #ifdef MTK_ARTSLIM_ENABLE
  MTK_RuntimeStart1(jit_options_.get(), this);
  #endif
...
void Runtime::DidForkFromZygote(JNIEnv* env, NativeBridgeAction action, const char* isa) {
  ...
  #ifdef MTK_ARTSLIM_ENABLE
  MTK_DidForkFromZygote(jit_options_.get(), this);
  #endif
...
void Runtime::CreateJit() {
  ...
  if (jit_.get() != nullptr) {
    ...
    #ifdef MTK_ARTSLIM_ENABLE
    MTK_CreateJit(jit_->instrumentation_cache_.get());
    #endif
  } else {
